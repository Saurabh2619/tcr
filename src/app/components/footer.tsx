    ...
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-12 relative overflow-hidden mt-3">
      <div className="container mx-auto px-6 md:px-12 lg:px-20 flex flex-col md:flex-row justify-between items-center relative z-10">
        ...
        <ul className="flex flex-wrap justify-center md:justify-start space-x-6 text-gray-300 text-md font-medium">
          <li><Link href="/" className="hover:text-blue-400 transition-all duration-300">Home</Link></li>
          <li><Link href="/mba" className="hover:text-blue-400 transition-all duration-300">MBA</Link></li>
          <li><Link href="/about" className="hover:text-blue-400 transition-all duration-300">About</Link></li>
          <li><Link href="/contact" className="hover:text-blue-400 transition-all duration-300">Contact</Link></li>
        </ul>
